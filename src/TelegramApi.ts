...
export class TelegramApi {
    ...
    async editMessageMedia(chatId: number, messageId: number, media: any, extra: Record<string, any> = {}) {
    ...
    async editMessageReplyMarkup(chatId: number, messageId: number, replyMarkup: any, extra: Record<string, any> = {}) {
    ...
    async sendMediaGroup(chatId: number | string, media: InputMedia[], extra: Record<string, any> = {}) {
    ...
    static createInlineButton(text: string, options: Partial<InlineKeyboardButton> = {}): InlineKeyboardButton {
        return {
            text,
            ...options
        };
    ...
    static createKeyboardButton(text: string, options: Partial<KeyboardButton> = {}): KeyboardButton {
        return {
            text,
            ...options
        };
